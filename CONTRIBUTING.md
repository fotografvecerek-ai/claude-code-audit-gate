...
English are welcome. Run `node tools/selftest.mjs` before every PR (must be 100 % PASS; 109/109 on Windows, 110/110 elsewhere).
...
## Jak testovat
```
node tools/selftest.mjs                 # brány, bus, gate-check, pre-commit (110 scénářů)
