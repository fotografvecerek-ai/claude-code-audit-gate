...
AUDITOR_YES=1 AUDITOR_REPO="$REPO" AUDITOR_WS="$WS" AUDITOR_REMOTE="" AUDITOR_MODEL=claude-fable-5-1 AUDITOR_KAPITAN=ne AUDITOR_HYGIENA=ne AUDITOR_CI=ne bash "$PKG/setup-auditor.sh" || { echo "Instalace auditora selhala."; exit 1; }
